...
/**
 * Test cases for doCreateItem
 */
public class MovieHandlerTest14 extends edu.gatech.cc.junit.FilteringTestCase {
  ...
  protected String getNameOfTestedMeth() {
    return "app.controller.MovieHandler.doCreateItem";
  }
  
  /**
   * Constructor
   */
  public MovieHandlerTest14(String pName) {
    super(pName);
  }
  ...
  public static junit.framework.Test suite() {
    return new junit.framework.TestSuite(MovieHandlerTest14.class);
  }
  ...
  public static void main(String[] args) {
    junit.textui.TestRunner.run(MovieHandlerTest14.class);
  }
}