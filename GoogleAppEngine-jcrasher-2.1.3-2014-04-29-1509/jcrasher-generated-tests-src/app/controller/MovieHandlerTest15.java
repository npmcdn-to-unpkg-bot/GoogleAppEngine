...
/**
 * Test cases for doGetItems
 */
public class MovieHandlerTest15 extends edu.gatech.cc.junit.FilteringTestCase {
  ...
  protected String getNameOfTestedMeth() {
    return "app.controller.MovieHandler.doGetItems";
  }
  
  /**
   * Constructor
   */
  public MovieHandlerTest15(String pName) {
    super(pName);
  }
  ...
  public static junit.framework.Test suite() {
    return new junit.framework.TestSuite(MovieHandlerTest15.class);
  }
  ...
  public static void main(String[] args) {
    junit.textui.TestRunner.run(MovieHandlerTest15.class);
  }
}