...
/**
 * Test cases for handleCalendar
 */
public class MovieHandlerTest25 extends edu.gatech.cc.junit.FilteringTestCase {
  ...
  protected String getNameOfTestedMeth() {
    return "app.controller.MovieHandler.handleCalendar";
  }
  
  /**
   * Constructor
   */
  public MovieHandlerTest25(String pName) {
    super(pName);
  }
  ...
  public static junit.framework.Test suite() {
    return new junit.framework.TestSuite(MovieHandlerTest25.class);
  }
  ...
  public static void main(String[] args) {
    junit.textui.TestRunner.run(MovieHandlerTest25.class);
  }
}