...
/**
 * Test cases for purgePastEvents
 */
public class MovieHandlerTest26 extends edu.gatech.cc.junit.FilteringTestCase {
  ...
  protected String getNameOfTestedMeth() {
    return "app.controller.MovieHandler.purgePastEvents";
  }
  
  /**
   * Constructor
   */
  public MovieHandlerTest26(String pName) {
    super(pName);
  }
  ...
  public static junit.framework.Test suite() {
    return new junit.framework.TestSuite(MovieHandlerTest26.class);
  }
  ...
  public static void main(String[] args) {
    junit.textui.TestRunner.run(MovieHandlerTest26.class);
  }
}