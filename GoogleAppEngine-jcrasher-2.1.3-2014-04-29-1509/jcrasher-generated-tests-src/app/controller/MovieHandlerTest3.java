...
/**
 * Test cases for getFilter
 */
public class MovieHandlerTest3 extends edu.gatech.cc.junit.FilteringTestCase {
  ...
  protected String getNameOfTestedMeth() {
    return "app.controller.MovieHandler.getFilter";
  }
  
  /**
   * Constructor
   */
  public MovieHandlerTest3(String pName) {
    super(pName);
  }
  ...
  public static junit.framework.Test suite() {
    return new junit.framework.TestSuite(MovieHandlerTest3.class);
  }
  ...
  public static void main(String[] args) {
    junit.textui.TestRunner.run(MovieHandlerTest3.class);
  }
}