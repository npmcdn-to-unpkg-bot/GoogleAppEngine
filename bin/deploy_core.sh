...
echo 'copying ' ${PROJECT_HOME}/GoogleAppEngine/war/WEB-INF/web.xml.core ' to ' ${PROJECT_HOME}/GoogleAppEngine/war/WEB-INF/web.xml ' ...'
cp -f ${PROJECT_HOME}/GoogleAppEngine/war/WEB-INF/web.xml.core ${PROJECT_HOME}/GoogleAppEngine/war/WEB-INF/web.xml
rm current.web.*
touch current.web.core
ls current.web.*
#./deploy_mac.sh