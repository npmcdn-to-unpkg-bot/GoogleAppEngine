...
echo 'copying ' ${PROJECT_HOME}/GoogleAppEngine/war/WEB-INF/web.xml.core_shiro ' to ' ${PROJECT_HOME}/GoogleAppEngine/war/WEB-INF/web.xml ' ...'
cp -f ${PROJECT_HOME}/GoogleAppEngine/war/WEB-INF/web.xml.core_shiro ${PROJECT_HOME}/GoogleAppEngine/war/WEB-INF/web.xml
rm current.web.*
touch current.web.core.shiro
ls current.web.*
#./deploy_mac.sh
