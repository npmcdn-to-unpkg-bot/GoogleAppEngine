...
<s:set name="namespace">/user</s:set>
...
<display:table id="user" name="paginatedList" defaultsort="1" pagesize="${pagesize}" export="false" requestURI="/user/index.action">
    <!-- Set the current user id -->
    <s:set name="id">${user.id}</s:set>
    ...
    <display:column property="passw" value="label.passw" sortable="true" />
    <display:column property="registration" value="label.registration" sortable="true" />
    ...
    <display:column title="${options}">
        ...
        <sj:dialog
            ...
            title="Remove User"
        >
        Do you want to remove user <s:property value="#id"/>?
        </sj:dialog>
        <!-- End: Remove dialog -->
