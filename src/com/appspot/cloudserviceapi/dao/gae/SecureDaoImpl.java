 ...
 * @author generated
 */
public class SecureDaoImpl extends GaeAbstractDaoImpl<Secure> implements SecureDao {

    private static final String TABLE_NAME = "Secure";

    public SecureDaoImpl( DatastoreService ds ) {
        super( ds );
    }
    ...
    public Secure findByPrimaryKey( long id ) {
        Entity _ent = entityGet( new KeyFactory.Builder( "Secure", id ).getKey());
    ...
    public boolean deleteByPrimaryKey( long id ) throws DaoException {
        return entityDelete( new KeyFactory.Builder( "Secure", id ).getKey() );
    }
...
//            _ent.setProperty( "lastAccessedDate", date( dto.getLastAccessedDate() ));
    ...
    protected Secure fetch( Secure dto, Entity ent ) {
        if ( dto == null ) dto = new Secure();
    ...
    protected Secure[] toArray(ArrayList<Secure> list ) {
        Secure[] ret = new Secure[ list.size() ];
