...
public class DrupalDropServlet extends HttpServlet {
	...
	public void doGet(final HttpServletRequest request,
		...
		try {
			...
			response
					.getWriter()
					.println(count++ + 
							": Drupal 6.2 table drops started, processing 47 SQL statements ...");

			queue.add(withUrl("/cibt/scripts/drop.jsp").method(Method.GET));
