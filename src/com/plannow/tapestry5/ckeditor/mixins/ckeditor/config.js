...
{
//	config.contentsCss = 'mycontents.css';
...
//	['equation', '-', 'Bold', 'Italic', '-', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink','-','About']
	['Source','-','FontColors','FontFormats','FontNames', 'FontSizes', 'Bold', 'Italic', '-', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink', 'Iframe','-','About']
	];
	...
	config.toolbarStartupExpanded = true;	//collapsed by default
};
