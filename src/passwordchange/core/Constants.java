...
public class Constants {
	...
	public static final String APP_URI = "/passwordchange";
	//NG
	public final static String PARSE_APP_ID = "parse.app.id";
	public final static String PARSE_MASTER_KEY = "parse.master.key";
	public static final String SIMPLE_LANDING_URL = APP_URI + "/jsp/simple.jsp";
	public static final String SIMPLE_CHANGE_PASSWORD_URL = APP_URI + "/jsp/simpleChangePassword.jsp";
	public static final String SIMPLE_CHANGE_EMAIL_URL = APP_URI + "/jsp/setupEmail.jsp";
	...
	public static final String SERVLET_URI = "/passwordchange";	//jboss should not require this
	public static final String LANDING_URL = SIMPLE_LANDING_URL;	//APP_URI + "/jsp/login.jsp";
	...
	public static final String RESET_TITLE = "Password Change Station";
	...
	public static final String CHANGE_EMAIL_TITLE = "Change Email Address";
