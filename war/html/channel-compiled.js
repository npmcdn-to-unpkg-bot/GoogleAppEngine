                ...
                for (var i = 0; i < obj.length; i++) {
                    if (i === App.header_index) {
                        ...
                        //                        $scope.serviceCheck($scope.page);
                            ...
                            var desc;
                            if (typeof obj[i].description !== 'undefined') desc = obj[i].description.value;else desc = "";
        ...
        success: function success(data) {
            ...
            if (data !== undefined) {
                ...
                Galleria.ready(function () {
                    ...
                    var stateChange = function stateChange(e) {
                        if (e.data == 1) {
                ...
                if (mcount1 === App.header_index) {
                    ...
                    //                            $scope.serviceCheck($scope.page);
                        ...
                        try {
                            ...
                            //}
                            var desc;
                            if (typeof obj[mcount1].description !== 'undefined') desc = obj[mcount1].description.value;else desc = obj[mcount1].description;
                            j = {
                                id: obj[mcount1].id,
...
function handleMovie(j, galleriaData) {
    ...
    if (galleria_type === 0) {
        /* VIDEO */
        if (j && j.url && tempMovieUrl.toLowerCase().indexOf("youtube.com") > -1) {
            //IE does not have toLowerCase???
            //===handle the subtitle
            galleriaData.push({
                dummy: '/images/noimage.jpg',
                video: tempMovieUrl,
    ...
    for (var i = 0; i < GALLERIA_LIMIT; i++) {
        ...
        try {
            ...
            if (type === 0) {
                ...
                //images
                if (type === 1) {
                    if ($("#i" + i).val().toLowerCase().indexOf(".png") > -1 || $("#i" + i).val().toLowerCase().indexOf(".jpg") > -1 || $("#i" + i).val().toLowerCase().indexOf(".gif") > -1) {
...
//# sourceMappingURL=channel-compiled.js.map