...
typeof define !== 'undefined' ? define(['require', 'exports', 'module'], function (require, exports, module) {
    //begin of AMD style
            ...
            if (srtUrl) {
                ...
                $.ajax({
                    ...
                    error: function error(_error) {
                        alert("Not able to load subtitle! Error: " + _error);
                    }
                });
            } else {
                return;
...
//# sourceMappingURL=YoutubeSubtitiles-compiled.js.map