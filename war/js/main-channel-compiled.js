...
requirejs(['./main-config', './app'], function (common, app) {
    requirejs(['jquery', 'purl', 'parse', 'facebook', 'angular', 'loglevel', 'prefs', 'movieApp', 'calendarApp', 'initUser', 'galleria', '../html/channel', 'countDown'], function ($, purl, Parse, facebook, angular, loglevel, prefs, movie, calendar, init, galleria, channel, countDown) {
        $(document).ready(function () {
            ...
            $('#noDays').countdown({ until: liftoffTime, onExpiry: function onExpiry() {
...
//# sourceMappingURL=main-channel-compiled.js.map