...
requirejs.config({
    ...
    shim: {
        ...
        //        },
        movieApp: {
            deps: ['jquery', 'calendarApp', 'parse', 'angular', 'prefsMovie', 'prefs']
        },
        jQueryUI: {
            deps: ['jquery']
        },
...
require(['./main-config', './app'], function (common, app) {
    require(['jquery', 'purl', 'parse', 'facebook', 'angular',
    //            'angularAnimate',
    //'loglevel',
    //'prefs',
    'movieApp', 'calendarApp', 'dateFormat', 'initUser',
    //'summernote',
    //'angularSummernote',
    'storejs'
    //, 'popup'
    ], function ($, purl, Parse, facebook, angular,
    //        angularAnimate,
    //loglevel,
    movie, calendar, dateFormat, init,
    //summernote,
    store
    //, popup
    ) //angularSummernote,
...
//# sourceMappingURL=main-movie-compiled.js.map