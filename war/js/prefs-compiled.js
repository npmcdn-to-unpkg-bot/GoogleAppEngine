...
define('prefs', [], function () {
    ...
    } else if (location.hostname.indexOf('teev.rhc') > -1 || location.hostname.indexOf('hudoon') > -1 || location.hostname.indexOf('hudoo.ne') > -1 || location.hostname.indexOf('hudoo.tv') > -1) {
        //ref implementation
    ...
    } else if (location.hostname.indexOf('creative') > -1) {
        //ref implementation
    ...
    */
    else if (location.hostname.indexOf('aware') > -1 || location.hostname.indexOf('share') > -1) {
            //2ShareIt
            //ref implementation
        ...
        } else if (location.hostname.indexOf('service') > -1 || location.hostname.indexOf('localhost') > -1 || //comment out this line to see how the default 2Share look and feel + behaviours!!!
...
//# sourceMappingURL=prefs-compiled.js.map