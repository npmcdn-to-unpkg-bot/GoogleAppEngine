...
'use strict';
angular.module('CrudServiceLib').factory('SrController',function($q,Configuration,HttpClient,APIHelper){
    return{
        /**
        ...
        /**
         * TODO: type endpoint description here
         * @param {string} id    Required parameter: Item unique id
         *
         * @return {promise<void>}
         */
        createDelete : function(id){
            ...
            //prepare query string for API call
            var baseUri = Configuration.BASEURI
            var queryBuilder = baseUri + "/api/jwt/fusr/delete";
