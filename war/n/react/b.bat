...
rem nodist use 5 && node_modules\.bin\webpack --display-modules --display-reasons --display-chunks %*
nodist use 5 && webpack --display-modules --display-reasons --display-chunks %*
