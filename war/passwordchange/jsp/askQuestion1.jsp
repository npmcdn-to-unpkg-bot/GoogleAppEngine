...
<html>
	...
	<body onLoad="setFocus('answer', 'text');">
		...
		<form name="PasswordChangeForm" action="../../passwordchange/validateQuestion1" method="POST" focus="userid" title="Use this screen to validate security questions">
<!--			
		<form name="PasswordChangeForm" action="../../passwordchange/promptQuestion1" method="POST" focus="userid">
-->
