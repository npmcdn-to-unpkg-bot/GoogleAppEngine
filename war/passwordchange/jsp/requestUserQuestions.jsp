...
<html>
    <head>
        ...
        <LINK href="/passwordchange/css/passwordchange.css" rel="stylesheet" type="text/css">
 		<SCRIPT type="text/javascript" src="/passwordchange/js/passwordchange.js"></script>
...
*/		
		...
		<form name="PasswordChangeForm" action="../../passwordchange/promptUserQuestions" method="POST" focus="userid" title="Use this screen to get your security questions">
<!--
		<form name="PasswordChangeForm" action="../../passwordchange/promptQuestion1" method="POST" focus="userid" title="Use this screen to get your security questions">
-->
