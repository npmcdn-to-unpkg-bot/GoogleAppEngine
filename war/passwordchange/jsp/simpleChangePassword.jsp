...
<head>
	...
	<div style="display:none;position:absolute;">
		<a href="#skip"> <img src="/passwordchange/images/skipnav.gif"
...
<body>
	...
	<form name="LogoutForm" method="post"
		action="../../passwordchange/logout"></form>
...
<li>Special Characters ( _  #  $)
				...
				<form name="PasswordChangeForm"
					action="../../passwordchange/simpleChangePassword" method="POST"
			...
			<table
				...
				<tr>
					<td valign="middle"><label for="LoginID" class=bstd>Login ID:
							</p></td>
				...
				<tr>
					<td valign="bottom"><input type="submit" name="simpleChangePassword"
